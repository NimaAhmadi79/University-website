    ...
    public String creat() {
        try {
            ...
            if (id < 7) {
                ...
                jo.put("family", result.getString(2));
                jo.put("email", result.getString(3));
                jo.put("phone", result.getString(4));
                jo.put("address", result.getString(5));
                jo.put("message", result.getString(6));
                if (result.getInt(7) == maxId) {
                    json += jo.toString();
